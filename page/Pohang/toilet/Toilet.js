...
export default function Toilet({ route, navigation }) {
          ...
          <View style={styles.add}>
            <View style={styles.add_wrapper}>
              <View style={styles.add_container}>
                <Text style={styles.add_subtitle}>대변기 개수</Text>
                <View style={styles.input_wrapper}>
                  <TextInput
                    name="name"
                    value={value.toiletCount}
                    onChangeText={(text) =>
                      setValue((prev) => {
                        return { ...prev, toiletCount: text };
                      })
                    }
                    style={styles.input}
                  ></TextInput>
